      ...
      <div className="form-group row">
        ...
        <div className="col-sm-8">
          <input 
            ...
            id="wallet" 
            disabled 
            value={Web3.utils.fromWei(user.balances.tokenWallet, 'ether')}
          />
        </div>
      </div>
      <div className="form-group row">
        <label htmlFor="contract" className="col-sm-4 col-form-label">Orderx</label>
        <div className="col-sm-8">
          <input 
            className="form-control" 
            id="wallet" 
            disabled 
            value={Web3.utils.fromWei(user.balances.tokenOrderx, 'ether')}
          />
        </div>
      </div>
          ...
          <div className="col-sm-8">
            <div className="input-group mb-3">
              <input 
                ...
                type="text" 
                className="form-control" 
                onChange={(e) => setAmount(Web3.utils.toWei(e.target.value, 'ether'))}
              />
